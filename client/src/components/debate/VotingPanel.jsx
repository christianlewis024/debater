...
import { castVote, getVoteCounts, hasUserVoted } from '../../services/voteService';
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
        ...
        {debaterA && (
          <div 
            onClick={() => !hasVoted && currentUser && !voting && handleVote(debaterA.id)}
            style={{
              background: winningA ? 'linear-gradient(135deg, rgba(59, 130, 246, 0.15) 0%, rgba(37, 99, 235, 0.05) 100%)' : 'rgba(31, 41, 55, 0.5)',
              border: winningA ? '2px solid rgba(59, 130, 246, 0.5)' : '1px solid rgba(255, 255, 255, 0.1)',
              borderRadius: '16px',
              padding: '20px 16px',
              cursor: (!hasVoted && currentUser && !voting) ? 'pointer' : 'default',
          ...
          >
            ...
            <div style={{ textAlign: 'center' }}>
              <img
                src={debaterA.profileData?.photoURL || 'https://ui-avatars.com/api/?name=User'}
        ...
        {debaterB && (
          <div 
            onClick={() => !hasVoted && currentUser && !voting && handleVote(debaterB.id)}
            style={{
              background: winningB ? 'linear-gradient(135deg, rgba(239, 68, 68, 0.15) 0%, rgba(220, 38, 38, 0.05) 100%)' : 'rgba(31, 41, 55, 0.5)',
              border: winningB ? '2px solid rgba(239, 68, 68, 0.5)' : '1px solid rgba(255, 255, 255, 0.1)',
              borderRadius: '16px',
              padding: '20px 16px',
              cursor: (!hasVoted && currentUser && !voting) ? 'pointer' : 'default',
              transition: 'all 0.3s ease',
          ...
          >
            ...
            <div style={{ textAlign: 'center' }}>
              <img
                src={debaterB.profileData?.photoURL || 'https://ui-avatars.com/api/?name=User'}
